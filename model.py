...
def unet(input_shape,
    ...
    conv_3 = Convolution2D(filters * 8, (kernel, kernel), padding = "same")(pool_1)
    conv_3 = BatchNormalization()(conv_3)
    conv_3 = Activation(activation)(conv_3)
    # conv_3 = Dropout(0.5)(conv_3)
    conv_4 = Convolution2D(filters * 8, (kernel, kernel), padding = "same")(conv_3)
    ...
    conv_5 = Convolution2D(filters * 16, (kernel, kernel), padding = "same")(pool_2)
    conv_5 = BatchNormalization()(conv_5)
    conv_5 = Activation(activation)(conv_5)
    # conv_5 = Dropout(0.5)(conv_5)
    conv_6 = Convolution2D(filters * 16, (kernel, kernel), padding = "same")(conv_5)
    conv_6 = BatchNormalization()(conv_6)
    conv_6 = Activation(activation)(conv_6)
    # conv_6 = Dropout(0.5)(conv_6)
    conv_7 = Convolution2D(filters * 16, (kernel, kernel), padding = "same")(conv_6)
    ...
    conv_8 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(pool_3)
    conv_8 = BatchNormalization()(conv_8)
    conv_8 = Activation(activation)(conv_8)
    # conv_8 = Dropout(0.5)(conv_8)
    conv_9 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(conv_8)
    conv_9 = BatchNormalization()(conv_9)
    conv_9 = Activation(activation)(conv_9)
    # conv_9 = Dropout(0.5)(conv_9)
    conv_10 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(conv_9)
    ...
    conv_11 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(pool_4)
    conv_11 = BatchNormalization()(conv_11)
    conv_11 = Activation(activation)(conv_11)
    # conv_11 = Dropout(0.5)(conv_11)
    conv_12 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(conv_11)
    conv_12 = BatchNormalization()(conv_12)
    conv_12 = Activation(activation)(conv_12)
    # conv_12 = Dropout(0.5)(conv_12)
    conv_13 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(conv_12)
    ...
    conv_14 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(pool_5)
    conv_14 = BatchNormalization()(conv_14)
    conv_14 = Activation(activation)(conv_14)
    # conv_14 = Dropout(0.5)(conv_14)
    conv_15 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(conv_14)
    conv_15 = BatchNormalization()(conv_15)
    conv_15 = Activation(activation)(conv_15)
    # conv_15 = Dropout(0.5)(conv_15)
    conv_16 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(conv_15)
    ...
    conv_17 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(concat_1)
    conv_17 = BatchNormalization()(conv_17)
    conv_17 = Activation(activation)(conv_17)
    # conv_17 = Dropout(0.5)(conv_17)
    conv_18 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(conv_17)
    conv_18 = BatchNormalization()(conv_18)
    conv_18 = Activation(activation)(conv_18)
    # conv_18 = Dropout(0.5)(conv_18)
    conv_19 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(conv_18)
    ...
    conv_20 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(concat_2)
    conv_20 = BatchNormalization()(conv_20)
    conv_20 = Activation(activation)(conv_20)
    # conv_20 = Dropout(0.5)(conv_20)
    conv_21 = Convolution2D(filters * 32, (kernel, kernel), padding = "same")(conv_20)
    conv_21 = BatchNormalization()(conv_21)
    conv_21 = Activation(activation)(conv_21)
    # conv_21 = Dropout(0.5)(conv_21)
    conv_22 = Convolution2D(filters * 16, (kernel, kernel), padding = "same")(conv_21)
    ...
    conv_23 = Convolution2D(filters * 16, (kernel, kernel), padding = "same")(concat_3)
    conv_23 = BatchNormalization()(conv_23)
    conv_23 = Activation(activation)(conv_23)
    # conv_23 = Dropout(0.5)(conv_23)
    conv_24 = Convolution2D(filters * 16, (kernel, kernel), padding = "same")(conv_23)
    conv_24 = BatchNormalization()(conv_24)
    conv_24 = Activation(activation)(conv_24)
    # conv_24 = Dropout(0.5)(conv_24)
    conv_25 = Convolution2D(filters * 8, (kernel, kernel), padding = "same")(conv_24)
    ...
    conv_26 = Convolution2D(filters * 8, (kernel, kernel), padding = "same")(concat_4)
    conv_26 = BatchNormalization()(conv_26)
    conv_26 = Activation(activation)(conv_26)
    # conv_26 = Dropout(0.5)(conv_26)
    conv_27 = Convolution2D(filters * 4, (kernel, kernel), padding = "same")(conv_26)
    ...
    conv_28 = Convolution2D(filters * 4, (kernel, kernel), padding = "same")(concat_5)
